...
check("static: APP_BUILD and cache bust agree on 67", appJs.indexOf("APP_BUILD = 67") !== -1 && (indexHtml.match(/v=67/g) || []).length >= 6);
...
check("static: SME Premium surfaces are disabled in the app", indexHtml.indexOf('id="sme-dashboard-root"') === -1 && appJs.indexOf("bsa-premium-sme") === -1 && appJs.indexOf("btn-premium-unlock") === -1 && appJs.indexOf("monthlySmeReport") === -1 && appJs.indexOf("whatsappSmeSummary") === -1);
...
check("static: review summary card leads with review amount", reportJs.indexOf('card("review", "Needs your review", fmtN(s.underReview || 0)') !== -1 && reportJs.indexOf("charge line(s) the auditor refuses to guess about") !== -1);
var accessMetaRows = [
