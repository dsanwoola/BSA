...
check("static: APP_BUILD and cache bust agree on 62", appJs.indexOf("APP_BUILD = 62") !== -1 && (indexHtml.match(/v=62/g) || []).length >= 6);
check("static: mobile hides stepper and Step 1 intro", appCss.indexOf(".stepper {\n    display: none;") !== -1 && appCss.indexOf("#step-context .panel > h2") !== -1 && appCss.indexOf("#step-context .panel > .lead") !== -1);
