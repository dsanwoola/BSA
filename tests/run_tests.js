...
check("static: public launch guidance appears in app", indexHtml.indexOf("Before you audit") !== -1 && indexHtml.indexOf("Find excess bank charges") !== -1 && indexHtml.indexOf("Start free audit") !== -1 && indexHtml.indexOf("Beta tester checklist") === -1 && indexHtml.indexOf("beta fixtures") === -1 && indexHtml.indexOf("anonymized parser diagnostic") !== -1 && appCss.indexOf(".launch-guide") !== -1 && appCss.indexOf(".launch-hero") !== -1);
...
check("static: APP_BUILD and cache bust agree on 65", appJs.indexOf("APP_BUILD = 65") !== -1 && (indexHtml.match(/v=65/g) || []).length >= 6);
